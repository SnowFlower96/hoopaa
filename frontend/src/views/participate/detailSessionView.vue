<template>
  ...
  <div class="detail-box-background" :style="customDetailSessionSize">
          ...
          <div class="upload-file-wrap">
            <div class="ufw-inner">
              <div>
                ...
                <div class="ufw-inner">
                  <div class="ufw-btn" @click="publishScreenShare">
                    공유하기
                  </div>
                </div>
              </div>
    ...
    <div class="detail-box-outer">
      ...
      <div class="detail-box-video" :style="customCaroselStyle">
        <div style="height:10%; color:white;" class="displayFlex">
          <p id="detailTimerDemo">0분0초</p>
        </div>
        <div class="detail-box-video-inner">
          <debate-room-video
            class="detail-session-vido"
  ...
  <div class="debate-room-footer-class-detail">
    <div @click="callModalFile" class="file-btn footer-btn">
...
export default {
  ...
  mounted() {
    ...
    let x = setInterval(function() {
      ...
      document.getElementById("detailTimerDemo").innerHTML =
        min + "분" + sec + "초";
      time--;
  ...
  async created() {
    ...
    await this.$store.dispatch(
      "getReToken",
      this.session.sessionId.split("_")[0]
    );
    console.log(this.$store.state.tempToken);
  },
  methods: {
...
.detail-box-video-inner::-webkit-scrollbar {
  width: 4px;
}
