...
export default {
    ...
    mounted() {
        ...
        // 토론방 센터 (.videobox-center)
        this.dCenterW = `${wValue075*0.48}px`
        ...
        // 토론방 화면공유 (.share-view)
        this.shareViewH = `${debateTimer*0.76}px`
        this.shareViewW = `${wValue075*0.46}px`

        // 토론방 양쪽 (.videobox-side)
        this.dSideW = `${wValue075*0.3-60}px`
        this.dSideH = `${hValue*0.93}px`
